...
namespace Day3_LINQ
{
    class Student : Person
    {
        ...
        public List<Student> GetStudents()
        {
            ...
            {
                new Student{ ID = 100, FirstName="ammar",LastName="yaser",Email="ammar.net@outlook.com",Password="123",MajorID=10235452556,
                    Profile= new Profile { ID=100,Address="amman",Age=37,Image="sdsdf.jpg"}},

                new Student{ ID = 101, FirstName="ali",LastName="khaled",Email="khaled.net@outlook.com",Password="1234",MajorID=10235452556,
